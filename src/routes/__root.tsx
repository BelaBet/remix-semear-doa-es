...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Semear" },
      { name: "description", content: "Semear: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { property: "og:title", content: "Semear" },
      { name: "twitter:title", content: "Semear" },
      { property: "og:description", content: "Semear: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { name: "twitter:description", content: "Semear: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
