...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Semear Doações" },
      { name: "description", content: "Semear Doações: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { property: "og:title", content: "Semear Doações" },
      { name: "twitter:title", content: "Semear Doações" },
      { property: "og:description", content: "Semear Doações: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
      { name: "twitter:description", content: "Semear Doações: plataforma para gestão de comunidades religiosas — eventos, doações, mensagens." },
